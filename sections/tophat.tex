...
For the \emph{interaction} semantics, we write $t,\sigma \interact{\iota} t',\sigma'$ to denote that task $t$ in state $\sigma$ transitions to task $t'$ in state $\sigma'$ after the user input $\iota$.
