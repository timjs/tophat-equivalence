...
\inlinecite[conf/ppdp/SteenvoordenNK19] introduces \TOPHAT, a formal language plus operational semantics for reasoning about task-oriented programs.
...
\startexample[exm:task-absolute-value]{Task equivalence}
  The next two tasks both ask end users to enter an integer,
  and thereafter show the absolute value of the given integer:
  \startformulas[align]
