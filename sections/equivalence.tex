...
According to \inlinecite[Sewell2009], a good definition of semantic equivalence should satisfy the following properties:
...
The fourth property about congruence states that if two programs $e_1$ and $e_2$ are semantically equivalent,
then we should be able to use $e_1$ and $e_2$ interchangeably within any program without changing its meaning.
Finally, the last property ensures that $\exprequiv$ is not just the empty relation.
